          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 f-category download-app">
              <a class="black download-button"  href="#download-app">
                ...
                <p class="pull-right">Download Now</p>
                </div>
              </a>
            </div>
...
">
                        ...
                        <h4>
                          <a href="<?=base_url('pages/articledetails/').$art_val->id.'/';?>"> 
                          <?=$art_val->title?></a>
                        </h4>
                      </div>
                      </div>
            ...
            <div class="touch-slider" class="owl-carousel owl-theme">
              <div class="item active text-center">  
                ...
                <div class="client-info">
                 <h2 class="client-name">"John Smith  <span>(Project Manager)</span></h2>
                </div>
   ...
   <?php if(!$this->session->has_userdata('user_logged_in')): ?>
    ...
    <div class="direct-chat-messages">          
        <div class="direct-chat-msg doted-border">
           <a href="<?=base_url();?>Login/member_normal_login/"class="btn btn-common log-btn center-block" style="margin-top: 50%;"><i class="ti-unlock"></i> Log In / Register</a>
           <div class="direct-chat-msg doted-border">
...
s1.async=true;
s1.src='https://embed.tawk.to/5d63d0c277aa790be330c5ba/default';
s1.charset='UTF-8';
...
<?php /*?><script>
  ...
  $("#Contact").click(function() {
         var id = this.id;
     $.ajax({
            url: '<?=base_url('pages/contact_us');?>', //This is the current doc
            type: "POST",
            data: ({ }),
            success: function(data){
            getdata=JSON.parse(data);
                     if(getdata['status']==false)
                     {
                       ...
                       swal("", "Please login to contact us!", "");

                       setTimeout(function(){ 
            window.location.replace("<?=base_url('login/member_normal_login');?>");
                         }, 2000);
                     }
                     ...
                     {
                       window.location.replace("<?=base_url('pages/contacts');?>");
