    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          ...
          <h2><span class="fa fa-newspaper-o"></span> All News</h2>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/list_news'); ?>"><li class="fa fa-minus icon-style"></li></a>
      ...
      echo form_open_multipart('admin/register/set_news', $attributes); 
      ...
      ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="form-group">
             ...
             <label for="title" class="col-md-3 col-xs-12 control-label">Description arbic</label>
                ...
                <div class="nopadding">                  
                  ...
                  <textarea class="form-control" name="Description_arbic" /></textarea>
          ...
          <div class="panel-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add News</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url('admin/register/All_news'); ?>",
        ...
        "columns": [
            ...
            { "title": "Title", "name":"Topic_name","orderable": false, "data":"title_arbic", "width":"0%" },            
...

        {
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/EditNews/'+aData['id']+'" ><i class="icon-edit"></i>&nbsp;Edit News</a></li>';

          action+='<li><a id="enroll" href="'+url+'admin/register/newsDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
