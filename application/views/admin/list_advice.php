...
<ul class="breadcrumb">
  ...
  <li class="active">Topics for advice</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-arrow-circle-o-left"></span> Topics for advice</h2>
        </div>
      ...
      echo form_open_multipart('admin/register/Addtopic', $attributes); 
      ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  ...
                  <input type="text" class="form-control" name="Topic_name" value="" required="" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Topic Name In Arbic</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control" name="Topic_name_arb" value="" required="" />
                </div>               
              </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/AllTopic'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Topics", "name":"Topic_name","orderable": false, "data":"topics", "width":"0%" },
            { "title": "Topics Arbic", "name":"Topic_name","orderable": false, "data":"topics_arbic", "width":"0%" },            
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/TopicDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
