...
class Index extends CI_Controller {
	...
	public function index()
	{
		...
		$data['paged_articles'] = $this->Web_modul_arbic->article_list('records',$start_from,$upto,$userID);
		$data['paged_news'] = $this->Web_modul_arbic->news_list('records',$start_from,$upto,$userID);
		$data['currnt_package'] = $this->Web_modul_arbic->user_currnt_running_package($userID);
		$this->load->view('website/arabic/index', $data);
