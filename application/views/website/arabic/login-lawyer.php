	...
	<div class="row">    
     ...
     <h2 class="section-title">سجل دخول</h2>
      ...
      <ul class="logins">
        ...
        <a href="<?=base_url('arabic/Login/Login_as_register_member');?>">
        ...
        <li>
          ...
          <a class="active" href="<?=base_url('arabic/Login/Login_as_register_lawyer');?>">
          ...
          <div class="tab-content">
            ...
            <div id="home" class="tab-pane fade in active">
              ...
              <div class="page-login-form">
                ...
                <form role="form" class="login-form" method="POST" action="<?=base_url('arabic/');?>Login/lawyer_normal_login/">
              ...
              <div id="menu1" class="tab-pane fade">
                ...
                <div class="page-login-form register">
                   ...
                   <?php  $attributes = array('class' => 'login-form', 'form'=>'form');
                        ...
                        echo form_open_multipart('arabic/Login/lawyer_registration');?>
                      ...
                      <div class="form-group">           
                        ...
                        <div class="input-icon">
                            ...
                            <input type="text" id="Text1" class="form-control" name="Name" placeholder="اسم" value="<?=set_value('Name');?>">
  ...
  <option value="زيمبابوي">زيمبابوي</option>
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input class="form-control" placeholder="أدخل رقمك" onkeypress="return isNumberKey(event)"   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15"    type="number" name="phone" value="<?=set_value('phone');?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="date" class="form-control" placeholder="تاريخ الولادة" name="Dob" 
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="text" class="form-control" placeholder="ترخيص رقم" name="Licence_no" 
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="text" class="form-control"  placeholder="تخصص" name="specialization"
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <i class="fa fa-building-o" aria-hidden="true"></i>
                           ...
                           <input type="text" class="form-control" name="Language_known" placeholder="اللغة التي تعرفها"  value="<?=set_value('Language_known');?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <i class="fa fa-building-o" aria-hidden="true"></i>
                           ...
                           <input type="text" class="form-control" name="Building_no" placeholder="لا للبناء"  value="<?=set_value('Building_no');?>">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="text" class="form-control" name="street_name" placeholder="رقم الشارع" value="<?=set_value('street_name');?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="text" class="form-control" name="region" placeholder="اسم المدينة">
                      ...
                      <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="district" placeholder="اسم الحي" value="<?=set_value('district');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="zip_code" placeholder="الرمز البريدي" value="<?=set_value('zip_code');?>" value="<?=set_value('zip_code');?>">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="input-icon">
                          ...
                          <input type="text" class="form-control" name="Additional_no" placeholder="رقم إضافي" value="<?=set_value('Additional_no');?>"  onkeypress="return isNumberKey(event)">
