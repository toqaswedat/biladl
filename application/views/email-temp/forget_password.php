...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="full">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><!-- <table width="76%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td style="font:bold 27px Arial, Helvetica, sans-serif; border-right:1px solid #dbdbdb;" class="smallfont">You have Successfully Registerd with GOLDMANDI...</td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                          </tr>
 ...
 -->                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" class="inner">
                          <tr>
                            <td style="font:14px/19px Arial, Helvetica, sans-serif; color:#333332; text-align:center;">Your Account Reset password generated successfully <br/>
                          ...
                          <tr>
                            <td align="center" class="readmore-button"><a href="<?=$UserDetail->link?>" style="font:bold 12px/29px Arial, Helvetica, sans-serif; color:#ffffff; text-decoration:none; margin:0 auto; background:#c02431;  padding:10px 19px; border-radius:24px; text-transform:uppercase;">Click me</a> To reset password</td>
                          </tr>
                        </table></td>
                      <td width="23" class="sidespace">&nbsp;</td>
                    </tr>
