...
class Ws extends REST_Controller {
    ...
    */
    function user_profile_details_post()
    {
     ...
     function user_profile_detailsget_post($userID)
    {
        $response = array('status' => false, 'message' => '', 'response' => array());
        $user_input = $this->client_request;
        extract($user_input);
    ...
    */
    function get_more_notification_post()
    {
        ...
        if(!$userID || $userID=='')
        {
         ...
         {
             $response = array('status' => false, 'message' => 'Your suspended!', 'response' => '');          
            $this->response($response);
         } 
...
/*
    ...
    */
    ...
    {   
         ...
         if(empty($package_details))
         {           
           $response = array('status' => false, 'message' => 'your package is expired or you are not subscribe any package yet!', 'response' => array());
            $this->response($response);
         }
        else
         {
    ...
    */
     function chat_message_post()
    {
        ...
        {   
            ...
            if(empty($chat_array))
            {
                $response = array('status' => false, 'message' => 'Unable to retrieve message', 'response' => array());
            }
            else
            {
    ...
    function user_package_checkout_post()
    {
         ...
         {           
          ...
          // $this->Hyper_pay->TEST('sdfdsf');
            $response_hyper= json_decode(Hyper_payRequest($parameters),true);
         $response = array('status' => true, 'message' => 'Key generation Successful!', 'response' => $response_hyper);
         $this->response($response);
          
    }
    
     function user_package_mada_checkout_post()
    {
         $response = array('status' => false, 'message' => '', 'response' => array());
         $user_input = $this->client_request;
         extract($user_input); 
         ...
         {           
          ...
          // $this->load->library('Payment/Hyper_pay');
          // $this->Hyper_pay->TEST('sdfdsf');
            $response_hyper= json_decode(Hyper_payRequestmada($parameters),true);
         $response = array('status' => true, 'message' => 'Key generation Successful!', 'response' => $response_hyper);
         $this->response($response);
    ...
    function Hyper_mada_Status_post()
    {
        $response = array('status' => false, 'message' => '', 'response' => array());
         $user_input = $this->client_request;
         extract($user_input);  
        ...
        $response_hyper = json_decode(Hyper_payStatusmada($parameters),true);
         $response = array('status' => true, 'message' => 'Key generation Successful!', 'response' => $response_hyper);
    ...
    function mihirtest_get()
    {

            $response = array('status' => true, 'message' => 'Mihir How are you ?!', 'response' =>  '');
