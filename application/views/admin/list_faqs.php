    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          ...
          <h2><span class="fa fa-question-circle"></span> All FAQ</h2>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/all_faqs'); ?>"><li class="fa fa-minus icon-style"></li></a>
      ...
      echo form_open_multipart('admin/register/AddFAQ', $attributes); 
      ...
      ?>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading">
            ...
            <h2 class="panel-title">Add FAQs</h3>            
          ...
          <div class="panel-body"> 
            ...
            <div class="form-group">
              ...
              <label for="title" class="col-md-3 col-xs-12 control-label">Title Arabic</label>
            ...
            <div class="form-group">
             ...
             <label for="title" class="col-md-3 col-xs-12 control-label">Description Arabic</label>
          ...
          <div class="panel-footer">
            ...
            <a href="<?=base_url();?>admin/home/all_faqs" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>            

            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add FAQ</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url('admin/register/faqs'); ?>",
...

        {
          ...
          action+='<ul class="dropdown-menu pull-right" style="text-align:left;">';
           ...
           action+='<li><a id="enroll" href="'+url+'admin/register/EditFAQ/'+aData['id']+'" ><i class="icon-edit"></i>&nbsp;Edit FAQ</a></li>';

          action+='<li><a id="enroll" href="'+url+'admin/register/FAQDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
