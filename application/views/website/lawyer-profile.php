						...
						<div class="all-courses">
                            ...
                            <table class="profile-table">
                                   <tr>
                                    ...
                                    Name:</td><td>
                                         <input type="text" class="form-control"  name="name" value="<?=$main_details->name;?>" >
                                     </td>
                                   </tr>
                                    <tr><td><i class="fa fa-mobile"></i>Phone:</td><td><?=$main_details->mobile;?></td></tr>
                            ...
                            <table class="profile-table">
                                    <tr>
                                        <td><i class="fa fa-id-card"></i>Specialization:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="special" value="<?=$extra_details->specialization;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-map-marker"></i>language:</td>
                                        <td>
                                             <input type="text" class="form-control"  name="languages" value="<?=$extra_details->languages;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-map-marker"></i>Building no:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="building_no" value="<?=$extra_details->building_no;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-map-marker"></i>District name:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="district" value="<?=$extra_details->district_name;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-map-marker"></i>Street Name:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="street" value="<?=$extra_details->street_name;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-user"></i>Zip code:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="zip_code" value="<?=$extra_details->zip_code;?>" required>
                                        </td>
                                        
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-id-card"></i>Alternate no:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="alternet_no" value="<?=$extra_details->alternet_no;?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-id-card"></i>Licence no:</td>
                                        <td>
                                            <input type="text" class="form-control"  name="licence_no" value="<?=$extra_details->licence_no;?>" required>
                                        </td>
                                    </tr>                                                   
                              </table>
                            </div>
