...
<div class="page-content-wrap">
  ...
  <div class="row">
   ...
   <?php 
      ...
      echo form_open_multipart('admin/register/AddNotification', $attributes); 
      ?>

      <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Notifications</h3>            
          </div>             
          <div class="panel-body">            
            ...
            <div class="form-group">
              <label for="whom" class="col-md-3 col-xs-12 control-label">For Whom</label>
              <div class="col-md-6 col-xs-12 ">
                <div class="">                  
                  <select class="form-control required"  name="whom" id="whom" required="">
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/ALLNotificatons'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "to", "name":"sno", "orderable": false, "data":"send_to", "width":"0%" },                    
            { "title": "Description", "name":"description","orderable": false, "data":"description", "width":"0%" },

            { "title": "Created Date", "name":"CreatedOn","orderable": false, "data":"created_on", "width":"0%" },
            { "title": "Actions", "name":"action", "orderable": false, "deafultContent":"", "data": "id", "width":"0%"}
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/NotificationDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
