<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <h4><a href="#" style="text-decoration:none;"><strong>مقالاتي المحفوظة</strong></a></h4>
    ...
    <?php foreach ($paged_articles as $art_key => $art_val) : ?>
        ...
        <div class="job-list">
            ...
            <div class="row">
                ...
                <h4><a href="job-details.html" ><?=$art_val->title_arbic?></h4>
                ...
                <div class="job-tag">
                    ...
                    <div class="pull-right">
                        ...
                        <div  data-desID="<?=$art_val->id?>" class="btn btn-common btn-rm redmore-js">قراءة المزيد</div>
            ...
            var urls='<?=base_url("arabic/pages/MoreArticles");?>';
             ...
             $.post(urls,Data_in_json).done(function(response){                               
...

                 {
                    ...
                    cliker.closest('.job-list').find('.desc-js').html(getdata['response'].description_arbic); 
...
<script type="text/javascript">
  ...
  $( ".bookmark-js").click(function() {
      ...
      var Data_in_json={artID: artID,bookmarkType: bookmarkType};
        ...
        var urls='<?=base_url("arabic/Login/AddBookmarks_article");?>';
