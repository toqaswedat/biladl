    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          ...
          <h2><span class="fa fa-newspaper-o"></span> All Article</h2>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69pxx;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>

            <input type="hidden" id="atpagination" value="">

            <input type="hidden" id="paginationlength" value="">

            <table id="users" class="table datatable table-striped" style="width: 100%;">
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/list_article'); ?>"><li class="fa fa-minus icon-style"></li></a>
      ...
      echo form_open_multipart('admin/register/set_article', $attributes); 
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body"> 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="title" value="" required="" />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="title_arbic" value="" required=""  />
            ...
            <div class="form-group">
              ...
              <label for="title" class="col-md-3 col-xs-12 control-label">Select Image</label>
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="file" class="form-control required" name="ImageName" required="" />
          ...
          <div class="panel-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add Article</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url('admin/register/All_article'); ?>",
...

        {
          ...
          action+='<ul class="dropdown-menu pull-right" style="text-align:left;">';
           ...
           action+='<li><a id="enroll" href="'+url+'admin/register/EditArticle/'+aData['id']+'" ><i class="icon-edit"></i>&nbsp;Edit Article</a></li>';

          action+='<li><a id="enroll" href="'+url+'admin/register/articleDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
