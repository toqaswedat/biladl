    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          ...
          <h2><span class="fa fa-link"></span> All Legal Documents</h2>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/Documents'); ?>"><li class="fa fa-minus icon-style"></li></a>
      ...
      echo form_open_multipart('admin/register/set_Document', $attributes); 
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body"> 
            ...
            <div class="form-group">
              ...
              <label for="title" class="col-md-3 col-xs-12 control-label">Select Document</label>
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="file" class="form-control required" name="ImageName" /> 
          ...
          <div class="panel-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add Legal Document</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url('admin/register/All_document'); ?>",
        ...
        "columns": [
            ...
            { "title": "Download_link", "name":"Type","Description": false, "data":"download_link", "width":"0%" },
...

        {
           ...
           // var imgTag = '<a href="' +url+ Image + '"/> View </a>';          

           // $(nRow).find('td:eq(3)').html(imgTag);



           var download_link = aData['download_link'];

           var download_link = '<a href="' +url+download_link+'">View</a>';          

           $(nRow).find('td:eq(3)').html(download_link);     
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/DocumentDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
