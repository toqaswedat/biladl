                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td style="font:bold 20px Arial, Helvetica, sans-serif; border-right:1px solid #dbdbdb;text-align: center;" class="smallfont">Shop Collection enquiry from Goldmandi</td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                          </tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      <td width="23" class="sidespace">&nbsp;</td>
                      <td style="padding:0px 0;" cellspacing="5" >
                          <table cellpadding="3" style="text-align: center;" width="100%">
                             <tr>
                              <th>Name</th>
                              <th>Phone</th>
                              <th>Email</th>                             
                            ...
                            <tr>
                              <td><?=$enquiry['shop_id'];?></td>
                              <td><?=$shop_details->shop_name;?></td>
                              <td><?=$enquiry['collection_no'];?></td> 
                            </tr>
                             <tr>
                              <th>Loaction</th>                           
                              <th>Contact No</th>
                             ...
                             <tr>
                              <td><?=$shop_details->location.''.$shop_details->sub_locatation;?></td>                              
                              <td><?=$shop_details->landline.','.$shop_details->mobile.','.$shop_details->other_no;?></td>                     
                            </tr>
                          </table><br><br><br>        
                          
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" class="inner">
                          <tr>
                            <td style="font:14px/19px Arial, Helvetica, sans-serif; color:#333332; text-align:center;"><?=date("l jS \of F Y h:i:s A");?><br />
