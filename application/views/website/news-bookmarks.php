<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <h4><a href="#" style="text-decoration:none;"><strong>News Bookmarks</strong></a></h4>
    ...
    <?php foreach ($paged_news as $news_key => $news_val) : ?>
        <div class="job-list">
            <div class="row">
                ...
                <h4><a href="<?=base_url('pages/NewsDetails/').$news_val->id.'/';?>" ><?=$news_val->title?></h4>
                ...
                <div class="job-tag">
                    ...
                    <div class="pull-right">
                        ...
                        <div  data-desID="<?=$news_val->id?>" class="btn btn-common btn-rm redmore-js"><a href="<?=base_url('pages/NewsDetails/').$news_val->id.'/';?>">View details</a></div>
                    </div>
                    </div>
                </div>
            </div>
