        ...
        <div class="container">
          <div class="row">         
            <div class="col-md-6" style="margin-left: 25%;padding-bottom: 15%;padding-top: 15%;">
               <form role="form" class="login-form" method="POST" action="<?=base_url()?>/Login/password_mobile">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="input-icon">                    
                          <input type="text" id="Text1" class="form-control num-only" name="Femail" placeholder="Please enter your mobile no" value="<?php echo set_value('LPassword'); ?>">
                          <?php echo form_error('LPassword'); ?>
                        </div>
                        <span><b>Note:</b></span>sms will sent to your mobile no
                      </div>
                    </div>
                  </div>       
