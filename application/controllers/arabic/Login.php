...
class Login extends CI_Controller {
	...
	{
		if(self::is_logged_in_true()){self::call_router(); return false;}
		if(!is_array($data)){ $data=array(); }
		 $data['title'] = "Biladil - Member login panel";
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/login_member.php', $data);
	...
	{
		if(self::is_logged_in_true()){self::call_router();}
		if(!is_array($data)){ $data=array(); }

		 $data['title'] = "Biladil - lawyer login panel";
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/login-lawyer.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	 ...
	 public function Login_as_register_trainee($data=array())
	{
		...
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/login-student.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	public function member_normal_login(){
		...
		//print_r($condition);exit;
      	...
      	if(empty($getData))
      	{
      		...
      		$message="<p class='form-error'>اسم المستخدم أو كلمة المرور غير صحيحة!</p>";
      		...
      		if($getData->status==1)
  			{
  				...
  				switch ($getData->type) {
  					...
  					case 'student':
  						...
  						break;  					
  					default:
  						self::Login_as_register_trainee();
  						break;
  				}
	...
	public function user_subscription($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 self::is_logged_in();
			$user_id =$this->session->userdata('user_id');
			 ...
			 $condition2= array('status' => 1);
		 		...
		 		$current_details = $this->Web_modul_arbic->user_currnt_running_package($user_id);		 		
		 		$all_packages = $this->Common_model->get_tables_records('packages','',$condition2);
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/user-suscritption.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
...
/* START
 Member dashbord login logout */
	...
	public function member_registration(){
		...
		$this->form_validation->set_rules('phone', 'Contact No.', 'required|regex_match[/^[0-9]{10}$/]|trim|callback_exit_phone');
   ...
   return false; } else { return true; }
	...
	public function Member_dashboard($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/user-profile.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	public function lawyer_dashboard($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);		 
		 $this->load->view('website/arabic/lawyer-profile.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	public function trainee_dashboard($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/trainee-profile.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
...
/* END
 Member dashbord login logout */
    ...
    public function forget_password()
	{
		...
		$this->load->view('website/arabic/include/header', $data);
		$this->load->view('website/arabic/forgot-password-user', $data);
		$this->load->view('website/arabic/include/footer.php', $data);
 ...
 Passswrod recover methods of all type of user */
	...
	public function password_reset_link()
	{
        ...
        'temp_pass' => $OTP
      	...
      	if(empty($getData))
      	{
      		...
      		$data['params'] = $params;
			$this->load->view('website/arabic/include/header', $data);
			$this->load->view('website/arabic/reset-password-user', $data);
			$this->load->view('website/arabic/include/footer.php', $data);
	...
	public function user_contact_us($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/user-contact.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	public function user_about_us($data=array())
	{
		if(!is_array($data)){ $data=array(); }
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/user-about.php', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	{		
	 ...
	 if(!is_numeric($start_from) || !isset($start_from) || $start_from < 1)
	 {
		...
		if($this->session->has_userdata('user_id'))
		{
		 ...
		 $totalDBrecords = $this->Web_modul_arbic->bookmarked_article_list('count',false,false,$userID);
		if($totalDBrecords<1)
		{
			$totalDBrecords=0;
		}
		...
		$paged_articles = $this->Web_modul_arbic->bookmarked_article_list('records',$start_from,$upto,$userID);
		...
		$data['C_page']=$arrange_data['curr_page'];
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/article-bookmarks', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
	...
	public function user_news_bookmarks($start_from=0)
	{
	 ...
	 if(!is_numeric($start_from) || !isset($start_from) || $start_from < 1)
	 {
		...
		if($this->session->has_userdata('user_id'))
		{
		 ...
		 $totalDBrecords = $this->Web_modul_arbic->bookmarked_news_list('count',false,false,$userID);
		if($totalDBrecords<1)
		{
			$totalDBrecords=0;
		}
		...
		$paged_news = $this->Web_modul_arbic->bookmarked_news_list('records',$start_from,$upto,$userID);
		...
		$data['C_page']=$arrange_data['curr_page'];
		 ...
		 $this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/include/sidebar-dashbord.php', $data);
		 $this->load->view('website/arabic/news-bookmarks', $data);
		 $this->load->view('website/arabic/include/footer.php', $data);
...
*/
	...
	public function AddBookmarks_article()
	{
		...
		if(!empty($getData))
		{
			if($bookmarkType=="REMOVE")
		     {
		        $results = $this->Web_modul_arbic->remove_bookmark_article_table($artID,$userID);
		        if(!$results)
		       {
         ...
         { 
          ...
          $bookmark = $this->Common_model->inset_to_tbl('bookmarks',$data);
           ...
           exit_with_json($response);
            ...
            $results = $this->Web_modul_arbic->update_bookmark_article_table($artID,$userID);
           if(!$results)
           {
	...
	public function AddBookmarks_news()
	{
		...
		if($bookmarkType=="REMOVE")
		{
		$results = $this->Web_modul_arbic->remove_bookmark_news_table($newsID,$userID);
			if(!$results)
			{
			    $response = array('status' => false, 'message' => 'Unable to Remove bookmark!', 'response' => '');
			}
         ...
         { 
           ...
           exit_with_json($response);
            ...
            $results = $this->Web_modul_arbic->update_bookmark_news_table($newsID,$userID);
           if(!$results)
           {
               $response = array('status' => false, 'message' => 'Unable to bookmark!', 'response' => array());
           }
	...
	public function GetFetureChat()
	{
		...
		$response = array('status' => false,'error_code'=>401,'message'=>'Not found','response'=>'');
		 ...
		 $history_convertion = $this->Web_modul_arbic->chat_Future($userID,$ENDChatID);
	...
	function GetMoreChat()
	{
		...
		$response = array('status' => false,'error_code'=>401,'message'=>'Not found','response'=>'');
		 ...
		 $history_convertion = $this->Web_modul_arbic->chat_History($userID,$lastChatID);
		if(empty($history_convertion)){
...
*/
	...
	public function testfile222()
	{
		...
		// $data['title'] = "Biladil - Member login panel";
		 //$this->load->view('website/arabic/include/header.php', $data);
		 $this->load->view('website/arabic/user-profile.html');

		 echo 
				'<script type="text/javascript">
					var baseurl="http://localhost/tapas/dell/biladl/assets/website/arabic/";
