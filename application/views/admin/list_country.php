...
<div class="page-content-wrap">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/country_page'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
      ...
      echo form_open_multipart('admin/register/Addcountry', $attributes); 
      ?>

        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Add Country</h3>            
          </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="counry_name" value="" placeholder="india" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Country code</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control required" name="country_code" value="" placeholder="IN" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">ISD Code</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="number" class="form-control number required" name="isd_code" placeholder="+91" value="" min="1" />
                </div>               
              </div>
            </div>            
          </div>
          <div class="panel-footer">
            ...
            <a href="<?=base_url();?>admin/home/country_page" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>            
            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add Country</button>
          </div>
        </div>
        </form>       
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/AllCountry'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "country code", "name":"Days","orderable": false, "data":"country_code", "width":"0%" },
            { "title": "ISD code", "name":"price","orderable": false, "data":"mob_code", "width":"0%" },       
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/DeleteCountry/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
