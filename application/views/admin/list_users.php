    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-users"></span> Members</h2>
        </div>
        <!-- <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/AddUsers" class="btn btn-success">Add</a></h3>
        </div> -->
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/AllMember'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          var action= '<div class="btn-group" role="group" aria-label="Basic example" style="width:150px;">'
           action +='<a class="btn btn-success "  href="'+url+'admin/register/ViewConvertion/'+aData['member_id']+'" >&nbsp;Chat</a>';           
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/view_user_document/'+aData['member_id']+'" ><i class="icon-edit"></i>&nbsp;View Uploaded document</a></li>';
          if(aData['status']!=9)
          {
            action+='<li><a id="enroll" onclick="'+act+'" href="'+url+'admin/register/User_Active_Deactive/'+aData['member_id']+'/Suspend" ><i class="icon-trash"></i>&nbsp;Suspend</a></li></ul>';
          }else
          {
            action+='<li><a id="enroll" onclick="'+act+'" href="'+url+'admin/register/User_Active_Deactive/'+aData['member_id']+'/active" ><i class="icon-trash"></i>&nbsp;Active</a></li></ul>';
          }
