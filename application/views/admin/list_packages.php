    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span></span>Purchase Packages</h2>
        </div>
      ...
      echo form_open_multipart('admin/register/Addpackage', $attributes); 
      ?>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body"> 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="package_title" value="" required=""  />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control required" name="package_title_arbic" value="" required="" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control required" name="package_type" value="" placeholder="Ex:- Monthly" required="" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control required" name="package_type_arbic" value="" required="" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="number" class="form-control number required" name="package_days" value="" min="1" required="" />
                </div>               
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">package price</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="number" class="form-control number required" name="package_price" value="" min="1" required="" />
                </div>               
              </div>
            </div> 
            ...
            <div class="form-group">
             <label for="title" class="col-md-3 col-xs-12 control-label">Description Arbic</label>
                <div class="col-md-6 col-xs-12">
                <div class="nopadding">                  
                  <textarea class="form-control summernote" id="txtEditor2" name="Description_arbic" /></textarea>
                </div>               
              </div>
            </div>
          </div>
          <div class="panel-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right" id="btnSubmit">Add package</button>
          </div>
        </div>
        </form>       
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/Packages'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Title arabic", "name":"Topic_name","orderable": false, "data":"title_arbic", "width":"0%" },
            { "title": "Type", "name":"Type","orderable": false, "data":"package_type", "width":"0%" },
            { "title": "Type arabic", "name":"Type","orderable": false, "data":"package_type_arbic", "width":"0%" },
            { "title": "Days", "name":"Days","orderable": false, "data":"total_days", "width":"0%" },
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          action+='<ul class="dropdown-menu pull-right" style="text-align:left;">';
           action+='<li><a id="enroll" href="'+url+'admin/register/EditPack/'+aData['id']+'" ><i class="icon-edit"></i>&nbsp;Edit package</a></li>';
          action+='<li><a id="enroll" href="'+url+'admin/register/PackageDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
