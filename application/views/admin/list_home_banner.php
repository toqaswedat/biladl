...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active"> Home Page Banner Manage</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
...
<div class="page-content-wrap">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-arrow-circle-o-left"></span> Home Page banners</h2>
        </div>
    ...
    <?php 
      ...
      echo form_open_multipart('admin/register/UploadHomePic', $attributes); 
      ?>

      <!-- END DATATABLE EXPORT -->
      <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title"> Banners for home page</h3>            
          </div>               
          <div class="panel-body">            
            ...
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Choose A image</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/ALLHomebanners'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Image", "name":"Images","orderable": false, "data":"image", "width":"0%" },

            { "title": "Banner Title", "name":"Banner_title","orderable": false, "data":"title", "width":"0%" },

            { "title": "Created Date", "name":"CreatedOn","orderable": false, "data":"created_at", "width":"0%" },
            { "title": "Actions", "name":"BanID", "orderable": false, "deafultContent":"", "data": "id", "width":"0%"}
        ...
        "fnCreatedRow": function( nRow, aData, iDataIndex) 
        {
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/HomebannersDelete/'+aData['id']+'" ><i class="icon-trash"></i>&nbsp;Delete</a></li></ul>';
