            ...
            <div class="col-md-12">
              ...
              <div class="breadcrumb-wrapper">
                ...
                <ol class="breadcrumb">
                  ...
                  <li><a href="#"><i class="ti-home"></i> حسابي</a></li>
     ...
     <h2 class="section-title">سجل دخول</h2>
      ...
      <ul class="logins">
        ...
        <li>
          ...
          <a class="active"  href="<?=base_url('arabic/Login/Login_as_register_trainee');?>">
    ...
    <div class="col-md-5 center-div cd-user-modal">
      ...
      <div class="my-account-form">
        ...
        <ul class="nav nav-tabs cd-switcher">
          ...
          <li class="active"><a data-toggle="tab" href="#home">تسجيل الدخول</a></li>
...
<li><a href="#0">REGITER</a></li>
    ...
    <div class="tab-content">
      ...
      <div id="home" class="tab-pane fade in active">
        ...
        <div class="page-login-form">
            ...
            <form role="form" class="login-form" method="POST" action="<?=base_url('arabic/');?>Login/trainee_normal_login/">
    ...
    <div id="menu1" class="tab-pane fade">
      ...
      <div class="page-login-form register">
        ...
        <?php  $attributes = array('class' => 'login-form', 'form'=>'form');
              ...
              echo form_open_multipart('arabic/Login/trainee_registration');?>
  ...
  <option value="زيمبابوي">زيمبابوي</option>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="input-icon">
                ...
                <input type="password" class="form-control matches" placeholder="Password" name="كلمه السر" id="password"  value="<?=set_value('password');?>">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="input-icon">
                ...
                <input type="text" class="form-control" name="current_institute" placeholder="اسم المعهد الحالي" value="<?=set_value('current_institute');?>" >
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="input-icon">
                ...
                <input type="text" class="form-control" name="course_name" placeholder="اسم الدورة التدريبية" 
            ...
            <div class="col-lg-6">
              ...
              <div class="input-icon">
                ...
                <input type="text" class="form-control" name="spacialization" placeholder="تخصص" value="<?=set_value('spacialization');?>" >
        ...
        <button class="btn btn-common log-btn">تسجيل</button>
