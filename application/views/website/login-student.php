        ...
        <div class="page-login-form">
            <form role="form" class="login-form" method="POST" action="<?=base_url();?>Login/trainee_normal_login/">
              ...
              <div class="form-group">
                <div class="input-icon">
                  <i class="ti-lock"></i>
                  <input type="password" class="form-control" name="LPassword" placeholder="Password" minlength="6" value="<?php echo set_value('LPassword'); ?>">
        ...
        <?php  $attributes = array('class' => 'login-form', 'form'=>'form');
           ...
           <div class="form-group">
              <div class="input-icon">
                    ...
                    <input type="text" id="Text3" class="form-control" name="ID_no" placeholder="identity Number" required="" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" value="<?=set_value('ID_no');?>">
              </div>
...
<div class="form-group">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-lg-6">
              <div class="input-icon">
                <input type="date" class="form-control" required="" placeholder="Date of birth" name="Dob" 
                value="<?=set_value('Dob');?>">
              </div>
     ...
     <!--        <div class="col-lg-6">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                        ...
                        <div class="col-md-9 col-xs-9">
                           <div class="input-icon">
                          <i class="ti-mobile"></i>
                          <input class="form-control numOnly" required="" placeholder="Enter your Mobile no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" onkeypress="return isNumberKey(event)"   type="number" name="phone" value="<?=set_value('phone');?>">
                        </div>
                         <?php echo form_error('phone'); ?> 
                        </div>
                      </div>
        ...
        <div class="form-group">
          <div class="input-icon">
            <i class="ti-email"></i>
            <input type="email" required="" id="sender-email" class="form-control" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="<?=set_value('email');?>">
          </div>
          ...
          <div class="row">            
            ...
            <div class="col-lg-12">
              <div class="input-icon">
                ...
                <input type="text" required="" class="form-control" name="current_institute" placeholder="Current Institute Name" value="<?=set_value('current_institute');?>" >
              </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="input-icon">
                ...
                <input type="text" class="form-control" required="" name="course_name" placeholder="Course name" 
            ...
            <div class="col-lg-6">
              <div class="input-icon">
                ...
                <input type="text" class="form-control" required="" name="spacialization" placeholder="Specialization" value="<?=set_value('spacialization');?>" >
              </div>
         ...
         <div class="form-group">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="input-icon">
                <i class="ti-lock"></i>
                <input type="password" required="" class="form-control matches" placeholder="Password" name="password" minlength="6" id="password"  value="<?=set_value('password');?>">
              </div>
