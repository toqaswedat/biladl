                ...
                <div class="page-login-form register">
                   <?php  $attributes = array('class' => 'login-form', 'form'=>'form');
                      ...
                      <div class="form-group">           
                        <div class="input-icon">
                            <i class="ti-user"></i>
                            <input type="text" id="Text1" class="form-control" name="Name" placeholder="Full Name" value="<?=set_value('Name');?>">
                        </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                          ...
                          <input type="text" name="mob_code" readonly class="form-control" id="mob_code" style="    padding-left: 10px">
                        </div>
                      ...
                      <div class="col-lg-12">
                        <div class="input-icon">
                          <i class="fa fa-building-o" aria-hidden="true"></i>
                           <input type="text" class="form-control" name="Language_known" placeholder="Language you know"  value="<?=set_value('Language_known');?>">
                        </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="district" placeholder="District Name" value="<?=set_value('district');?>">
                        </div>
                      ...
                      <div class="col-lg-6">
                        <div class="input-icon">
                        <i class="ti-world" aria-hidden="true"></i>
                        <input type="text" class="form-control" name="zip_code" placeholder="Zip Code" value="<?=set_value('zip_code');?>" value="<?=set_value('zip_code');?>">
                        </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="input-icon">
                          <i class="fa fa-road" aria-hidden="true"></i>
                          <input type="text" class="form-control" name="street_name" placeholder="Street No" value="<?=set_value('street_name');?>">
                        </div>
                      ...
                      <div class="col-lg-6">
                        <div class="input-icon">
                          <i class="fa fa-building-o" aria-hidden="true"></i>
                           <input type="text" class="form-control" name="Building_no" placeholder="Building No"  value="<?=set_value('Building_no');?>">
                        </div>
