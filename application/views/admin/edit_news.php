...
<div class="page-content-wrap">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/register/UpdateNews', $attributes); 
      ...
      ?>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">       
            ...
            <input type="hidden" name="rowid" value="<?=$news_Details->id; ?>" />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="title" value="<?=$news_Details->title; ?>"  />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control required" name="title_arbic" value="<?=$news_Details->title_arbic; ?>"  />
                ...
                <label for="title" class="col-md-3 col-xs-12 control-label">Description</label>
                  ...
                  <div class="col-md-6 col-xs-12">
                    ...
                    <div class="nopadding">                  
                      ...
                      <textarea class="form-control" name="Description" /><?=$news_Details->description; ?></textarea>
              ...
              <label for="title" class="col-md-3 col-xs-12 control-label">Description arbic</label>
                ...
                <div class="col-md-6 col-xs-12">
                  ...
                  <div class="nopadding">                  
                    ...
                    <textarea class="form-control" name="Description_arbic" /><?=$news_Details->description_arbic; ?></textarea>
