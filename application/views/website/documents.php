...
<section class="find-job useful-links documents section inner-articles">
	<div class="container">
	<h2 class="section-title">Useful Documents</h2>
				...
				<div class="job-list">
					<div class="row">
						<div class="job-list-content col-lg-9">
							<h4><i class="fa fa-file-pdf-o" aria-hidden="true"></i><a target="_next" href="<?=base_url($Doc_val->download_link);?>"><?=$Doc_val->title?></a></h4>
						</div>
					</div>
				</div>
				<?php endforeach; ?>
