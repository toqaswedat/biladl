    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          ...
          <h2><span class="fa fa-user"></span> lawyer</h2>
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/view_lawyer'); ?>"><li class="fa fa-minus icon-style"></li></a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url('admin/register/All_lawyer'); ?>",
        ...
        "columns": [
            ...
            { "title": "Other Details", "name":"Type","Description": false, "data":"country", "width":"0%" },
...

        {
          ...
          var  act="return confirm('Are you sure you want to suspend/Active the account?')";
           ...
           action +='<p><b>specialization : </b>'+aData['specialization']+'</p>';

           action +='<p><b>languages : </b>'+aData['languages']+'</p>';

           action +='<p><b>building no : </b>'+aData['building_no']+'</p>';

           action +='<p><b>District name : </b>'+aData['district_name']+'</p>';
           ...
           action +='<p><b>county_code : </b>'+aData['county_code']+'</p>';

           action +='<p><b>country : </b>'+aData['country']+'</p>';
          ...
          action+='<li><a id="enroll" href="'+url+'admin/register/view_user_document/'+aData['lawyer_id']+'" ><i class="icon-edit"></i>&nbsp;View Uploaded document</a></li>';

          if(aData['status']!=9)

          {

            action+='<li><a id="enroll" onclick="'+act+'" href="'+url+'admin/register/User_Active_Deactive/'+aData['lawyer_id']+'/Suspend" ><i class="icon-trash"></i>&nbsp;Suspend</a></li></ul>';

          }else

          {

            action+='<li><a id="enroll" onclick="'+act+'" href="'+url+'admin/register/User_Active_Deactive/'+aData['lawyer_id']+'/active" ><i class="icon-trash"></i>&nbsp;Active</a></li></ul>';
